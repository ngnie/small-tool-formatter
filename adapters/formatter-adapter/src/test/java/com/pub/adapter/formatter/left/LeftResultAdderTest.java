...
public class LeftResultAdderTest {
    ...
    static Stream<Arguments> errantArguments() {
        return Stream.of(
                Arguments.of(null, new StringBuilder(), "Trying to add alignment to result. Alignment is null"),
                Arguments.of(new StringBuilder(), null, "Trying to add alignment to result. Result is null"));
    }
    ...
    static Stream<Arguments> validArguments() {
        return Stream.of(
                ...
                Arguments.of("foo", "", "foo\n", "Alignment not empty. Add to result"),
                Arguments.of("foo", "bar\n", "bar\nfoo\n", "Alignment and result not empty. Add to result"));
    }

    @ParameterizedTest
    @MethodSource("validArguments")
    public void testLeftResultAdder(String alignment, String result, String expected) {
